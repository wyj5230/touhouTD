...
function CDOTA_BaseNPC:THTD_yuyuko_thtd_ai()
    ...
    print( ability2:GetAutoCastState() )
    print( THTDSystem:FindRadiusWeakUnitCount(self,ability2:GetCastRange()) )
    print( THTDSystem:FindRadiusWeakUnitCount(self,ability2:GetCastRange()-400) )
	if ability2:GetLevel()>0 and ability2:IsCooldownReady() and self:IsChanneling() == false and ability2:GetAutoCastState() and
